...
Cake, pastry, and sandwich are most commonly bought in tandem with Coffee. Oddly, Juice is also frequently bought with Coffee... We can only assume that this is due multiple people in a party and hopefully not that people are drinking both.

```{r}
inspect(head(rules,by="confidence",n=10))
```

More interesting are the association rules. 