...
The original dataset was put on Kaggle but deleted: https://www.kaggle.com/deleted-dataset/50231. Fortunately someone reuploaded the data: https://www.kaggle.com/sulmansarwar/transactions-from-a-bakery.

What we'll be doing in my first kernel is a little exploratory analysis followed by a Market Basket Analysis.
...
# Sales over time
We have an idea of what we're selling so now let's plot it against our various measures of time. Each transaction lists both time and date, we'll take a large step back and look at sales over all time.
...
This is a more fare representation of 'business' throughout the week. Saturday is still the top dog. Sunday falls behind Friday, however. We might guess that on Sunday we have more generous customers buying for their friends, or even that Sunday tends to be a day when customers buy more than 1 or 2 items.
...
As we thought, 2 items per purchase is the norm, with between 2 and 3 items purchased on Sundays.
...
People buy the most items per transaction between 10am and 5pm. 
